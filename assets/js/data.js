...
window.COURSE_DATA = {
    ...
    teachers: {
      ...
      Li: { id:"Li", name:"李雪琦", title:"硕导, 副研究员", bio:"研究方向：领域专用加速器（DSA）; 近存计算架构（PIM）; 算法-架构-工艺跨层协同优化。", photo:"assets/img/lxq.webp", research: [
          {
            heading: "个人简历",
            items: [
              "2023年09月—至今：中国科学院计算所副研究员，课题组长",
              "2021年07月—2023年09月：中国科学院计算所助理研究员，课题组长",
              "2018年10月—2020年08月：美国加州大学圣塔芭芭拉分校，电机与计算机工程系，联合培养博士",
              "2014年09月—2021年06月：中国科学院计算所，计算机系统结构专业，博士生",
              "2010年09月—2014年06月：中国地质大学（武汉），信息工程专业，本科生（李四光计划）",
            ]
          },
          {
            "heading": "主要论著",
            "items": [
              "Ruihao Gao, Zhichun Li, Guangming Tan, Xueqi Li*. BeeZip: Towards An Organized and Scalable Architecture for Data Compression. ACM Conference on Architectural Support for Programming Languages and Operating Systems (ASPLOS)",
              "Xun Wang, Ruibao Song, Junmin Xiao, Tong Li, Xueqi Li*. Accelerating k-Shape Time Series Clustering Algorithm Using GPU. Transactions on Parallel and Distributed Systems (TPDS)",
              "Yewen Li, Xueqi Li*, Ruihao Gao, Wanqi Liu, Guangming Tan. NvWa: Enhancing Sequence Alignment Accelerator Throughput via Hardware Scheduling. IEEE International Symposium on High-Performance Computer Architecture (HPCA)",
              "Di Xu, Peiheng Zhang, Yang Zhang, Shunchen Shi, and Xueqi Li*. TransCaller: An End-to-end Accelerated Transformer-based Nanopore Basecaller on GPUs. IEEE International Conference on Bioinformatics and Biomedicine (BIBM)",
              "Zhen Du, Jiajia Li, Yinshan Wang, Xueqi Li, Guangming Tan, Ninghui Sun. AlphaSparse: Generating High Performance SpMV Codes Directly from Sparse Matrices. International Conference for High Performance Computing, Networking, Storage, and Analysis (SC)",
              "Tong Li, Xueqi Li*, Yewen Li, Ruibao Song, Xun Wang*. Crescent: A GPU-based Targeted Nanopore Sequence Selector. IEEE International Conference on Bioinformatics and Biomedicine (BIBM)",
              "Xueqi Li, Guangming Tan, Ninghui Sun. PIM-Align: A Processing-in-Memory Architecture for FM-index Search Algorithm. Journal of Computer Science and Technology (JCST)",
              "Wenqin Huangfu, Xueqi Li, Shuangchen Li, Xing Hu, Peng Gu, Yuan Xie. MEDAL: Scalable DIMM based Near Data Processing Accelerator for DNA Seeding Algorithm. IEEE/ACM International Symposium on Microarchitecture (MICRO)",
              "Dylan Stow, Itir Akgun, Wenqin Huangfu, Yuan Xie, Xueqi Li, Gabriel H. Loh. Efficient System Architecture in the Era of Monolithic 3D: Dynamic Inter-tier Interconnect and Processing-in-Memory. Design Automation Conference (DAC)",
              "Yuanrong Wang, Xueqi Li, Dawei Zang, Guangming Tan, Ninghui Sun. Accelerating FM-index Search for Genomic Data Processing. International Conference on Parallel Processing (ICPP)",
              "Xueqi Li, Guangming Tan, Bingchen Wang, Ninghui Sun. High-performance genomic analysis framework with in-memory computing. ACM SIGPLAN Symposium on Principles and Practice of Parallel Programming (PPoPP)",
              "Xueqi Li, Guangming Tan, Yuanrong Wang, Ninghui Sun. The Genomic Benchmark Suite: Characterization and Architecture Implications. HPCA Workshop on Accelerator Architecture In Computational Biology and Bioinformatics (AACBB)"
            ]
          },
          {
            heading: "科研项目",
            items: [
              "国家重点研发计划：超异构软硬件协同计算统一框架，“领域专用加速器跨层优化关键技术研究”子课题负责人。",
              "青年科学基金项目：面向基因比对的存算一体架构关键技术研究，项目负责人。",
              "中国科学院特别研究助理资助项目：面向基因组学大数据的存算一体关键技术研究，项目负责人。",
              "博新计划：面向基因组学大数据的存算一体关键技术研究，项目负责人。"
            ]
          },
          {
            heading: "获奖及荣誉",
